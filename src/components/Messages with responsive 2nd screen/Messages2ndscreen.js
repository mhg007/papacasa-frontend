...
import return__icon from "./Asessts/Images/mobile menu icons/return__icon.svg";
              ...
              <main className="chat-window">
                ...
                <div className="chat-header">
                  <h2>
                    <img
                      src={return__icon}
                      className="messages-return-icon"
                    />
                    Jeena Ray
                  </h2>
...
export default Messages2ndscreen;
